import { useOptimistic, useState, useTransition, version } from "react";
...
export const InstagromApp = () => {
    ...
    const handleAddComment = async (formData: FormData) => {
        ...
        startTransition(async () => {
            ...
            if (messageText !== "Mensaje de fallo") {
                setComments((prev) => [
                    ...prev,
                    {
                        id: new Date().getTime(),
        ...
        <div className="bg-slate-700 h-screen flex flex-col items-center justify-center">
            ...
            <div className="flex flex-col items-center justify-center bg-gray-300 rounded-t-3xl p-4 w-[500px]">
                ...
                <p className="text-black font-bold mb-4">
                    {version}Mira que interesante esta funcionalidad de la API de React.
                </p>
            </div>
