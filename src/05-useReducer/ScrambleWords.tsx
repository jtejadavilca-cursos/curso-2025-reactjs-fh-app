...
import { getScrambleWordsInitialState, scrambleWordsReducer } from "./reducer/screambleWordsReducer";
...
export const ScrambleWords = () => {
    ...
    const handlePlayAgain = () => {
        dispatch({ type: "RESET_GAME", payload: getScrambleWordsInitialState() });
    };
