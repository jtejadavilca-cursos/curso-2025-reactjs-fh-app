...
export const getScrambleWordsInitialState = () => {
    const shuffledWords = shuffleArray(GAME_WORDS);
    const clearState: ScrambleWordsState = {
...
export const scrambleWordsReducer = (state: ScrambleWordsState, action: ScrambleWordsActions) => {
    switch (action.type) {
        case "SET_GUESS": {
            return {
                ...state,
